        ...
        <div className="container py-2">
            <div className="row g-5">
                ...
                <div className="col-lg-3 col-md-6">
                    ...
                    <p className="mb-2"><i className="fa fa-map-marker-alt me-3"></i>Dadar East, Mumbai</p>
                    <p className="mb-2"><i className="fa fa-phone-alt me-3"></i>1800 80 1454</p>
                    <p className="mb-2"><i className="fa fa-envelope me-3"></i>Helpdesk@DineEazy.com</p>
            ...
            <div className="copyright">
                <div className="row">
                    <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        ...
                        <p>&copy; DineEazy &nbsp;Copyright, All Right Reserved.</p>
                    </div>
