...
public class RestaurantInfoController 
{
	...
	public String restaurantRegistration(@PathVariable long mobileNo, @PathVariable String pwd, @PathVariable String name, @PathVariable String address, @PathVariable String city, @PathVariable String contactPersonName, @PathVariable long phoneNo, @PathVariable String emailId, @PathVariable double minBookingAmountPerPerson, @PathVariable String openingTime, @PathVariable String closingTime, @PathVariable long restaurantContactNumber, @PathVariable int numberOfSeatAvailable)
	{
		...
		List<TableFoodInfoEntity> foodInfoList = new ArrayList<TableFoodInfoEntity>();
		
		TableFoodInfoEntity foodInfo1 = new TableFoodInfoEntity();
		foodInfo1.setCategory("ppp");
		foodInfo1.setCusineType("iiii");
		foodInfo1.setFoodName("mmmm");
		foodInfo1.setUnitPrice(500);
		foodInfoList.add(foodInfo1);
		
		TableFoodInfoEntity foodInfo2 = new TableFoodInfoEntity();
		foodInfo2.setCategory("ggg");
		foodInfo2.setCusineType("hhh");
		foodInfo2.setFoodName("eee");
		foodInfo2.setUnitPrice(300);
		foodInfoList.add(foodInfo2);
		
		restInfo.setFoodInfoList(foodInfoList);
